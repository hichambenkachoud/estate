...
class LoginFormBackAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException($this->trans->trans('admin.credentials.invalid'));
        }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->router->generate('backend_index'));
    }
